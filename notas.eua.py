# esse está funcionando, e é mais simples. 


def nota():

     # Converta uma nota de 0 a 100 em uma escala de letras(A,B,C) etc, como se fosse nos estados Unidos. 
    # boas vindas do codigo!
    print(" <<<<<<< Bem vindo ao ミ★ Sistema de Notas ★彡!>>>>>>") # boas vindas!, SE a pessoa digitar números negativos, ou maior que 100, ele imprime "Nota inválida! Por favor digite uma nota de 0 a 100!""
